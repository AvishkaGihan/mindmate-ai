...
export const errorHandler = (
  ...
  if (config.env === "development") {
    ...
    // We also need the prototype chain for instanceof checks or specific properties
    // that might not clone cleanly with simple spread, so we check names on original `err` too.
